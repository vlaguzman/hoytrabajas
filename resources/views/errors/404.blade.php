...
<html>
   <head>
      <title>HOYTRABAJAS :: ERROR 404 ... </title>
      <meta charset="utf-8">
 ...
 <body>
  <div class="fondo">
     <div class="wrap">
		...
		<div class="content">
			<h1 class='error_num'>404 </h1>
			<p><span><label></label>Uffs...</span>La pagina solicitada no esta disponible. </p>
			<a href="{!! url('/') !!}">Ir al inicio</a>
   		</div>
	 </div>
  </div>
   <footer class="main-footer3 text-color-3" style="max-height: 100px;text-align: center">
       <strong>Hoy Trabajas  © 2017. Todos los derechos reservados. Design By CRIZZ. </strong>
   </footer>
 </body>
</html>
