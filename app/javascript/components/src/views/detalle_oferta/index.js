...
const DetallePage = ({offer, relatedOffers, pathAppliedOffers, translationOffer, csrf_name, csrf_token, log_out_companies, company_signed_in, user_signed_in, log_out_user}) => {
    ...
    <Row className='pcx align-items-start mb-30' >
      <Col xs={8}>
        <Paper className='p-50' >
          ...
          <Row className='my-10 mx-0'>
            <Typography variant='caption'><span className='fw-bold' >{ translationOffer.close }</span>{offer.close_date}</Typography>
            <Typography className='ml-10' variant='caption'> <span className='fw-bold' > 26</span>{ translationOffer.aplications }</Typography>
          </Row>
          ...
          <form action={pathAppliedOffers} method='post'>
            ...
            <input type="hidden" name="applied_offer[offer_id]" value={offer.id_offer} />
            <Button variant='contained' type="submit" color='primary' className={ classNames('text-white my-50', { 'button-disabled': offer.is_applied }) } style={{borderRadius: '50px'}}  >
              { valueButton }
            </Button>
          </form>
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.targeted_offer }</Typography></Col>
              <Col xs={6} ><Typography variant='body1' className='fw-bold' >{ offer.sex.description }</Typography></Col>
          </Row>
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.age }</Typography></Col>
              <Col xs={6} ><Typography variant='body1' className='fw-bold' >{ `${offer.age_range.from } a ${offer.age_range.to}` }</Typography></Col>
          </Row>
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.vacancy_numbers }</Typography></Col>
              <Col xs={6} ><Typography variant='body1' className='fw-bold' >{offer.vacancies_quantity}</Typography></Col>
          </Row>
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.recident }</Typography></Col>
              <Col xs={6} ><Typography variant='body1' className='fw-bold' >{offer.city.description}</Typography></Col>
          </Row>
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.experience }</Typography></Col>
              <Col xs={6} ><Typography variant='body1' className='fw-bold' > {(offer.required_experience) ? "Requerida": "No requerida" } </Typography></Col>
          </Row>
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.lenguage }</Typography></Col>
          ...
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.type_ofert }</Typography></Col>
              <Col xs={6} ><Typography variant='body1' className='fw-bold' >{ offer.offer_type.description }</Typography></Col>
          </Row>
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.work_mode }</Typography></Col>
              <Col xs={6} ><Typography variant='body1' className='fw-bold' >{ offer.work_mode.description }</Typography></Col>
          </Row>
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.terms }</Typography></Col>
              <Col xs={6} ><Typography variant='body1' className='fw-bold' >{offer.contract_type.description}</Typography></Col>
          </Row>
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.salary }</Typography></Col>
          ...
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.days }</Typography></Col>
              <Col xs={6} ><Typography variant='body1' className='fw-bold' >{offer.available_work_days.map(value => (<div>{value}</div>) )}</Typography></Col>
          </Row>
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.working_day }</Typography></Col>
              <Col xs={6} ><Typography variant='body1' className='fw-bold' >{offer.working_days.map(value=>(<div>{value}</div>)) }</Typography></Col>
          </Row>
          <Row className='justify-content-between'>
              <Col xs={6} ><Typography variant='body1' className='' >{ translationOffer.benefits }</Typography></Col>
              <Col xs={6} ><Typography variant='body1' className='fw-bold' >{ translationOffer.transport_aid }</Typography></Col>
          </Row>
      ...
      <Col xs={4} >
        <Card >
          ...
          <Row className='justify-content-between'>
              <Col xs={9} ><Typography variant='body1' className='' >{`${offer.company.employees_range.description} ${translationOffer.employees}`}</Typography></Col>
              <Col xs={3} ><FontAwesomeIcon className='ml-auto text-primary' icon={['fas', 'users']} size="sm" /></Col>
          </Row>
          <Row className='justify-content-between'>
              <Col xs={9} ><Typography variant='body1' className='' style={{color: 'grey'}} ><u>{ translationOffer.contact_company }</u></Typography></Col>
