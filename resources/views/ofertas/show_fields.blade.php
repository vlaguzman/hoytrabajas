...
<div class="row">
   <div class="col-md-12">
       <div class="single-blog" >
              ...
              <h2>{{ $oferta->nombre }}</h2>
              <ul class="post-meta">
                  <li><i class="fa fa-pencil-square-o"></i><strong> Creado por: </strong> {{ Empleador::find($oferta->empleador_id)->first()->contacto }}</li>
                  <li><i class="fa fa-clock-o"></i><strong> {{ $oferta->created_at->diffForHumans() }}</strong></li>
              </ul>
              <div class="blog-content">
                  <p> {{ $oferta->descripcion }}.</p>
							...
							<hr/>
							<div class="blog-content">
										<p> {{ Ciudad::find($oferta->ciudad_id)->first()->descripcion }}  - {{ $oferta->direccion }}   </p>
										<h5 class='text-right color_bprecio' > <i class="fa fa-usd" aria-hidden="true"></i>  {{ $oferta->paga }} COP.<h5>
							</div>
      </div>
   </div>
</div>
    ...
    <div class="row f_gris">
        <div class="col-md-2">
           <div class="center-block ">
               <img src="{{  Usuario::find( Empleador::find( $oferta->empleador_id )->first()->user_id )->first()->url_imagen   }} " class="profile-picture-1 img-responsive center-block"  width="74px" alt="User Image"/>
           </div>
        </div>
        <div class="col-md-2">
...
<div class="row f_gris">
   ...
   <div class="col-md-2">
        <div class="text-center">
            <div class="fb-share-button" data-href="http://www.hoytrabajas.com" data-layout="button" data-size="small" data-mobile-iframe="false">
                <a class="fb-xfbml-parse-ignore btn_image f_gris" target="_blank"
                     href="https://www.facebook.com/sharer/sharer.php?u=http://www.hoytrabajas.com&src=sdkpreparse">
							...
							@foreach($empleados2 as $item)
											...
											<div class="media-right">
												<a class="button button-block"  href="{!! route('msgs.historico', $item->userid) !!}"  >
													 <i class="fa fa-comment-o fa-4x l_secundary" aria-hidden="true"></i>
												</a>
											</div>
										</li>
										<hr/>
