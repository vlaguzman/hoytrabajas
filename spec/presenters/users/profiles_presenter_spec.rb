  ...
  describe "#basic_user_data" do
    ...
    context "When the attributes not have value" do
      ...
      it "Should return the translation" do
        ...
        result = {
          email:                 { value: user.email,                           class_empty: '' },
          name:                  { value: "Completa tu información",    class_empty: 'incomplete' },
          last_name:             { value: "Completa tu información",    class_empty: 'incomplete' },
          contact_number:        { value: "Completa tu información",    class_empty: 'incomplete' },
          birthday:              { value: "Completa tu información",    class_empty: 'incomplete' },
          document_type:         { value: "Completa tu información",    class_empty: 'incomplete' },
          ...
          driving_licences:      { value: ["Completa tu información"],  class_empty: 'incomplete' },
          born_state:            { value: "Completa tu información",    class_empty: 'incomplete' },
          born_city:             { value: "Completa tu información",    class_empty: 'incomplete' },
          offer_types:           { value: ["Completa tu información"],  class_empty: 'incomplete' },
          work_modes:            { value: ["Completa tu información"],  class_empty: 'incomplete' },
          job_categories:        { value: ["Completa tu información"],  class_empty: 'incomplete' },
          available_work_days:   { value: ["Completa tu información"],  class_empty: 'incomplete' },
          contract_type:         { value: "Completa tu información",    class_empty: 'incomplete' },
          labor_disponibility:   { value: "Completa tu información",    class_empty: 'incomplete' },
          travel_disponibility:  { value: "No",                         class_empty: ''           },
          salary:                { value: "Completa tu información",    class_empty: 'incomplete' },
        }
