module Users::Wizards::StepSixService
  def self.call(curriculum_vitae: _, update_params: {})
    execute_update(curriculum_vitae: curriculum_vitae, update_params: update_params)
  end

  private

  def self.execute_update(curriculum_vitae: _, update_params: {})
    update_params.delete(:technical_skills)
    update_params.delete(:to_learn_skills)

    #TODO Oscar Temporaly comment until we have technical skills
    #update_strong_params(curriculum_vitae,
    #  strong_skills_params: update_params.delete(:technical_skills)
    #)

    #update_to_learn_params(curriculum_vitae,
    #  to_learn_skills_params: update_params.delete(:to_learn_skills)
    #)

    update_languages_params(curriculum_vitae,
      languages_params: update_params.delete(:languages)
    )

    Users::WizardService.update_curriculum_vitae(curriculum_vitae,
