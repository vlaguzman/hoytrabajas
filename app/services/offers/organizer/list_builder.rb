module Offers::Organizer::ListBuilder
  ...
  def self.call(curriculum_vitae_id = nil, previous_results: [], limit: nil)
    offer_ids_groups(curriculum_vitae_id, previous_results: previous_results, limit: limit)
  end

  def self.offer_ids_groups(curriculum_vitae_id = nil, previous_results: [], limit: nil)
    ...
    on_demand_ids_list = previous_results.any? ?
  ...
  def self.standard_no_applied_offer_ids_list(curriculum_vitae_id = nil, previous_results: [], limit: nil )
    applied_offers = applied_offers_list(curriculum_vitae_id)
  ...
  def self.offer_ids_list(limit: nil, previous_results: [])
    previous_results.present? ? previous_results : ids_extractor(active_most_recently_created(limit: limit))
  end
